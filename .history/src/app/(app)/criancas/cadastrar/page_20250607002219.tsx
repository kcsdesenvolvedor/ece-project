// app/(app)/criancas/cadastrar/page.tsx
'use client'
...
export default function RegisterChildPage() {
  ...
  const [state, dispatch] = useFormState(registerChild, initialState);

  // TODO: Buscar os planos do banco de dados para popular o Select
  const plans = [
      {id: 1, name: "Integral"},
