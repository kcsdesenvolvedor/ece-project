...
export default async function DashboardPage() {
  ...
  // Garantir que metrics sempre será do tipo DashboardMetrics
  function isDashboardMetrics(obj: any): obj is DashboardMetrics {
    return obj && typeof obj.total_children === 'number' && typeof obj.monthly_revenue === 'number' && typeof obj.present_today === 'number' && typeof obj.absent_today === 'number';
  }

  const metrics: DashboardMetrics = isDashboardMetrics(metricsResponse.data)
    ? metricsResponse.data
    : { total_children: 0, monthly_revenue: 0, present_today: 0, absent_today: 0 };
